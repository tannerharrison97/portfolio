...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // This is a mock submission - in a real project, you would connect to an API
    try {
      // Simulate API call
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.contactInfo}>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <p className={styles.infoValue}>+1 (123) 456-7890</p>
              </div>
            </div>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <p className={styles.infoValue}>contact@example.com</p>
              </div>
            </div>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <p className={styles.infoValue}>New York, NY, USA</p>
              </div>
            </div>
          ...
          <div className={styles.formContainer}>
            <h3 className={styles.subtitle}>Send Me a Message</h3>
